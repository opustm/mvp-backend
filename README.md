...
##DEPLOYMENT: For now we have stuck to Heroku for the sake of familiarity. Future plans possibly include deplyment on AWS. To ensure that we always have a working build, the main and staging branches are hosted on two different heroku deployments:
