from main.viewsets import CliqueMessageViewset, RequestViewset, DirectMessageViewset, ReactionViewset, ToDoViewset, CliqueViewset, UserViewset, InvitationViewset, EventViewset, ScheduleViewset, TimeFrameViewset, AnnouncementViewset
