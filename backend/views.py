...
def documentation(request):
    ...
    <html>
        ...
        <body>
            ...
            <h1>Custom Views</h1>
            <p>Objects can be individually accessed using custom attributes that better fit the use-case of each table.</p>
            <p>This shows that you can query a table with values other than its primary key!</p>
            <h3>User</h3>
            <ul>
                <li><a href="/main/users/">/main/users/</a>Read(GET) all users. Create(POST) new users</li>
                <li><a href="/main/users/vansjo01@luther.edu">/api/users/&lt;userEmail&gt;</a>Get user by email.</li>
            </ul>
            <h3>Team</h3>
            <ul>
                <li><a href="/main/teams/">/main/teams/</a>Read(GET) all users. Create(POST) new teams</li>
                <li><a href="/main/teams/FlatEarthers/">/main/teams/&lt;teamName&gt;</a>Get team by name.</li>
            </ul>
            <h3>Invitation</h3>
            <ul>
                <li><a href="/main/invitations/">/main/invitations/</a>Read(GET) all invitations. Create(POST) new Invitations</li>
                <li><a href="/main/invitations/abc123/">/main/invitations/&lt;invitationCode&gt;</a>Get invitation by code.</li>
            </ul>
            <h3>Event</h3>
            <ul>
                <li><a href="/main/events/">/main/events/</a>Read(GET) all events. Create(POST) new events</li>
                <li><a href="/main/events/1">/main/events/&lt;eventid&gt;</a>Get event by id. Also, Update(PUT), Delete(DELETE)</li>
            </ul>
        </body>
    </html>
    '''
