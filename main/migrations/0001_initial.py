    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id', models.UUIDField(default=uuid.UUID('ee4d7abc-9c9b-4a97-8cc1-ae64f2ee719f'), editable=False, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('relatedCliques', models.ManyToManyField(blank=True, related_name='_clique_relatedCliques_+', to='main.Clique')),
            ],
            options={
                'verbose_name': 'clique',
